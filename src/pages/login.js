...
export default function Login() {
    ...
    useEffect(() => {
        document.title = 'Login - Chadstagram'
    }, []);

    return (
        <div className="container flex mx-auto max-w-screen-md items-center h-screen">
            <div className="flex w-3/5">
                <img src="/images/iphone-with-profile.jpg" alt="iPhone with Chadstagram" />
            </div>
            <div className="flex flex-col w-2/5">
                <div className="flex flex-col items-center bg-white p-4 border border-gray-primary mb-4">
                    <h1 className="flex justify-center w-full">
                        <img src="/images/logo.png" alt="Chadstagram" className='mt-2 w-6/12 mb-4'/>
                    </h1>
                ...
                <div className="flex jusitfy-center items-center felx-col w-full bg-white p-4 border border-gray-primary">
